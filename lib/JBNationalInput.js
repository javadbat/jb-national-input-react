...
import { useEvent } from '../../../Utils/CustomHooks/useEvent';

// eslint-disable-next-line react/display-name
const JBNationalInput = React.forwardRef((props, ref) => {
    /**
    ...
    return (
        <jb-national-input placeholder={props.placeholder?props.placeholder:''} ref={element} class={props.className?props.className:''} label={props.label?props.label:''} message={props.message?props.message:''}>
        </jb-national-input>
    );
});

JBNationalInput.propTypes = {
